...
\subsection{Análise 5}\label{anuxe1lise-5}

\subsection{Análise dos perfis das idades dos clientes paracada loja da
cidade de Âmbar
Seco.}\label{anuxe1lise-dos-perfis-das-idades-dos-clientes-paracada-loja-da-cidade-de-uxe2mbar-seco.}

\begin{figure}[H]

\caption{\label{fig-}Boxplot da idade (anos) pelo número da loja de
Âmbar Seco}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{entrega_3_files/figure-pdf/fig--1.pdf}}
